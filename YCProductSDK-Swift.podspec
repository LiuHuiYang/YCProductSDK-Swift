#
#  Be sure to run `pod spec lint YCProductSDK-Swift.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "LiuHuiYang" => "liuhuiyang2009@163.com" }
  # Or just: spec.author    = "LiuHuiYang"
  # spec.authors            = { "LiuHuiYang" => "liuhuiyang2009@163.com" }
  # spec.social_media_url   = "https://twitter.com/LiuHuiYang"
  ...
  spec.source       = { :git => "https://github.com/LiuHuiYang/YCProductSDK-Swift.git", :tag => "#{spec.version}" }
